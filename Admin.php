...
<body>
  ...
  <nav>
    ...
    <ul id="nav" style="z-index: 999; color: white;">
        ...
        <li><a  href="login.php" class="nav-link">Quitter</a></li>
      </ul>
    <!--button-->
    <!--button-->
...
<!--End Navigation-->
  ...
  <!--Card: deposer card-->
  <div id="form_deposer"  class="card deposer-card w-100 m-auto border-0">
    <!--card body-->
    <div class="card-body" id="deposss">
  ...
  <!--Card: retirer card-->
  <div class="card retirer-card w-100 m-auto mt-5 border-0" id="retirer" style="align-items: center;">
    <!--card body-->
    <div class="card-body" id="retirerrr">
  ...
  <div class="compte" id="compte">
    <div id="bt">
      <div class="add-account-btn">
        <a id="ajouter_compte" href="#" class="Btn_add" style="background-color: green;">Ajouter un compte</a>
      </div>
    </div>
    ...
    <form action="Admin.php" method="post" class="search-form">
      <div class="search-inputs">
        ...
        <div class="search-buttons">
          ...
          <input value="Effacer" type="reset" name="submit" style="background-color: red;">
        </div>
      </div>

      <select id="select"  style="margin-top: 10px;" name="select" class="form-select" aria-label="Default select example">
    ...
    <header>
        <h3>Liste des comptes et opérations</h3>
    </header>
  ...
  <div id="ddddd" class="d-flex w-100 mt-3" style="justify-content: center; ">
    <div class="data1" id="hhh">
      <h4>Etat de Guichet de la banque</h4>
      <?php $message = ""; ?>
      <form id="form" action="paiement.php" method="post">
        ...
        <button name="Guichet" type="submit">Sauvegarder</button>
      </form>
    </div>
  </div>
