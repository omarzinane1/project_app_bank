    ...
    <div style="display: flex;
        ...
        <div class="search mb-5 mt-2">
            ...
            <form action="Map.php" method="post">
                <input  name="search" type="text" class="form-control" placeholder="Rechercher Par Ville">
                <button style="background-color: #2596be;" name="submit" class="btn btn-primary">Rechercher</button>
            </form>
