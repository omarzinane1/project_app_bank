    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            ...
            <select name="transact-type" class="form-control my-3" id="transact-type">
                ...
                <option value="Cheque" style="width: 70%;">Paiment par Chèque</option>
            ...
            <form action="paiement.php" method="post" style="background-color: #f0f0f0;font-family: Arial, sans-serif;">
                <div class="card payment-card" style="background-color: #f0f0f0;font-family: Arial, sans-serif;">
                    ...
                    <div class="card-body" style="background-color: #f0f0f0;font-family: Arial, sans-serif;">
                        ...
                        <!--form group-->
                        <div class="form-group mb-2">
                            <label for="">N° compte expéditeur</label>
                            <input type="text" name="copmexp" class="form-control" id="" placeholder="Saisir N° compte">
                        </div>
                        <div class="form-group mb-2">
                ...
                <div class="card transfer-card" style="background-color: #f0f0f0;font-family: Arial, sans-serif;">
                    ...
                    <div class="card-body" style="background-color: #f0f0f0;font-family: Arial, sans-serif;">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="numcompte" class="form-control" id="" placeholder="Saisir N° compte">
                        </div>
                        <!--form group-->
                        <div class="form-group">
                            <label for="">Sélectionner Le Compte</label>
                        ...
                        <div class="form-group mb-2">
                            <label for="">N° compte expéditeur</label>
                            <input type="text" name="numcompteexpd" class="form-control" id="" placeholder="Saisir N° compte">
                        </div>
                        <!--form group-->
                        <div class="form-group mb-2">
            ...
            <!--payer par cheack-->
            <form id="chak" action="paiement.php" method="post">
                ...
                <button id="butt5" name="cheque" type="submit">Pays</button>
                                ...
                                <div class="wrapp">
                                    <div class="content">
                                        <div id="nia" class="data">
                                            ...
                                            <p><b style="color: black;"><i class="fa-solid fa-key" style="font-size: 20px;"></i></b><br><span><?= $row['user_id'] ?></span></p>
                                            <p><b  style="color: black;"><i class="fa-solid fa-user" style="font-size: 20px;"></i></b><br><span><?= $row['last_name'] ?> <?= $row['first_name'] ?></span></p>
                                            <p><b style="color: black;"><i class="fa-solid fa-envelope" style="font-size: 20px;"></i></b><br><span id="mail"><?= $row['email'] ?></span></p>
                                            <p><b style="color: black;"><i class="fa-solid fa-phone" style="font-size: 20px;"></i></b><br><span>........</span></p>
                                            <p><b style="color: black;"><i class="fa-solid fa-lock" style="font-size: 20px;"></i></b><br><span><?= $row['password1'] ?></span></p>
                                        </div>
                                    </div>
                                </div>
                            </ul>
